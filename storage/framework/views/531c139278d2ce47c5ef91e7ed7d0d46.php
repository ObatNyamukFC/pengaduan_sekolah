...
<body class="min-h-screen bg-gray-800 flex items-center justify-center">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-md w-full max-w-md">
        ...
        <form action="<?php echo e(route('login.admin.proses')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Username</label>
                <input type="text" name="username" placeholder="Masukkan username" value="<?php echo e(old('username')); ?>"
...
</html><?php /**PATH C:\laragon\www\pegaduan_siswa\resources\views/login_admin.blade.php ENDPATH**/ ?>